...
const restaurantCards: RestaurantCard[] = [
  ...
  {
    id: 5,
    name: "Fast Food Grill",
    imageUrl: "https://images.unsplash.com/photo-1594212699903-ec8a3eca50f5?ixlib=rb-1.2.1&auto=format&fit=crop&w=2160&q=80",
    rating: 4.3,
    reviewCount: "(200+)",
    distance: "2.5 mi",
    deliveryTime: "20 min",
...
export default function TopLunchSpots() {
  return (
    <div className="mb-10">
      <div className="flex justify-between items-center mb-4">
        <div>
          <h2 className="text-xl font-semibold">Top 5 lunch spots</h2>
          <p className="text-gray-600 text-sm">Based on orders placed in the past week</p>
        </div>
        <SeeAllButton href="/lunch-spots" />
      </div>
